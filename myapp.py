...
def update_coin_data():
    if st.session_state is not None:
        ...
        coin_dataframe.dataframe(coin_df_sorted, hide_index=True, use_container_width=True, height=500)
...
# 초기 코인선택 대상 설정
text_values = ["KRW-BTC", "KRW-ETH", "KRW-XRP", "KRW-VET","KRW-STEEM", "KRW-ETC", "KRW-SAND", "KRW-XEC", "KRW-DOGE", "KRW-SHIB", "KRW-BCH", "KRW-XEM"]
