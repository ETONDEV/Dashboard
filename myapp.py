...
####### 종목 입력 #######
# 코인
text_values = ["KRW-BTC", "KRW-ETH", "KRW-ETC", "KRW-SAND", "KRW-JST", "KRW-QTUM", "KRW-EOS", "KRW-NEO", "KRW-TRX", "KRW-XRP", "KRW-VET","KRW-STEEM", "KRW-XEC", "KRW-DOGE", "KRW-BEAM", "KRW-BCH", "KRW-ANIME", "KRW-BTT", "KRW-SNT", "KRW-VTHO"]
# 주식          삼성    2차전지 나스닥   하이닉스  
